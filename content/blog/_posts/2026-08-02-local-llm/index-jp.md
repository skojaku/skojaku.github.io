...
その上で、作業が発生したらまず [Forgejo](https://forgejo.org/)(セルフホストできるGitHubのようなもの)上にタスクを作ることを癖にしている。こうしておくと、どんなタスクがあったか後から見返せる。タスクにはセッションが紐付いているので、具体的なステップを知りたければセッションを参照すればよい。あとで見返して、自動化できるポイントを探すのに役立てている。
